...
{
    MOTORSHIELD_IN1=AIN1;
    MOTORSHIELD_IN2=AIN2;
    MOTORSHIELD_IN3=BIN1;
    MOTORSHIELD_IN4=BIN2;
    SPEEDPIN_A	=PWMA;
    SPEEDPIN_B	=PWMB;
...
#ifdef DEBUG
    Serial.print("pwm");
    Serial.println(SPEEDPIN_A);
    Serial.print("pin1 ");
    Serial.println(MOTORSHIELD_IN1);
    Serial.print("pin2 ");
    Serial.println(MOTORSHIELD_IN2);
    Serial.print("speed ");
